...
const TOUR=(function(){
 ...
 /* 门洞在客厅北墙 x 3.60–5.20，站位和视线都必须落在这一段里，
    否则相机是对着门洞旁边的实墙拍的。 */
 {p:PT('f1','客厅',0.83,0.90),   l:PT('f1','餐厨一体',0.75,0.35,1.20), d:2.2, n:'客厅 → 餐厨一体（1.60 m 门洞）'},
 ...
 /* 门在餐厨东墙 y 5.60–6.40。视线终点原来落在 y=5.36，在门洞下缘之外，穿的是墙。 */
 {p:PT('f1','餐厨一体',0.80,0.30), l:PT('f1','走廊',0.50,0.42,1.45),     d:1.8, n:'餐厨 → 走廊'},
 ...
 /* 原来对着中柱拍特写，一格钢管。改成从半高俯看玄关厅，交代「上到一半回头看」的关系。 */
 {p:[8.72,18.42,3.30], l:[7.05,16.85,1.70], d:2.0, n:'旋转梯上行（第 9 级）· 回看玄关厅'},
